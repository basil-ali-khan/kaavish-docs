...
\\
\\
\textbf{Turab Hussain Usmani}:  Turab will concentrate on shaping and validating the project’s core machine learning models. He will work to benchmark models for unsupervised anomaly detection and predictive systems, assessing their accuracy, resilience, and efficiency under real-time conditions. In both his course on \textit{Large Language Models} and his research work in the \textit{Tehqiq 2} program where he evaluated both supervised and unsupervised machine learning methods and gained hands-on experience in comparing and stress-testing different models, developing a strong foundation in assessing accuracy, robustness, and efficiency. This background equips him to ensure that the system’s machine learning backbone is reliable and deployable under real-world conditions.
